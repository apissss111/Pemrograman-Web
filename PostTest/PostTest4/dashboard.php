...
<body>
    ...
    <main class="container">
        ...
        <section id="galeri">
            ...
            <article>
                <h3>Foto 1</h3>
                <img src="https://via.placeholder.com/250" alt="Foto 1">
            </article>
            <article>
                <h3>Foto 2</h3>
                <img src="https://via.placeholder.com/250" alt="Foto 2">
            </article>
            <article>
                <h3>Foto 3</h3>
                <img src="https://via.placeholder.com/250" alt="Foto 3">
            </article>

            <!-- Form tambah foto -->
            <section>
                <h3>Silakan Tambah Foto Anda di Sini</h3>
                <form action="#" method="post" enctype="multipart/form-data" class="card">
                    <label for="uploadFoto">Pilih Foto:</label>
